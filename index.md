...
- **來信的保留與刪除**：您寄送至上述信箱的信件（含寄件人 Email 與信件內容）由開發者於處理完畢後保留至多 **6 個月**供爭議追溯，逾期刪除。本 App 為個人開發，此項清理由開發者**定期人工執行**，並非自動化流程；若您希望提前移除，可來信**要求即時刪除**，我們會優先處理。同樣的保留與刪除方式適用於您依 §2.2 送出的意見回饋表單內容。
